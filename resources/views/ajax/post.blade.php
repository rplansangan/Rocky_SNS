<li class="media">
	...
	<div class="media-body">
		...
		@endif
		<i class="fa fa-thumbs-up"></i>&nbsp;<span class="like-counter">{{{ isset($like) ? 0 : $like->count() }}} </span> 
		<i class="fa fa-comment"></i>&nbsp;<span class="comment-counter">{{{ isset($comments) ? 0 : $comments->count() }}}</span>&nbsp; 
