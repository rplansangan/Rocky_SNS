...
<div class="adshop-content col-sm-12 col-xs-12 col-lg-12 col-md-12">
	...
	<div class="col-sm-12 col-xs-12 col-lg-6 col-md-6 adshop-container">
		<div class="col-sm-12 col-xs-12 col-lg-12 col-md-12 adshop-img">
		...
		<div class="col-sm-12 col-xs-12 col-lg-12 col-md-12 adshop-img">
			<img src="{{ URL::asset('assets/images/ad22.jpg') }}" width="500px">
			<div class="btn_adshop">
				<a href="">VIEW</a>
				<a href="">INQUIRE</a>
				<a href="">ORDER</a>
		...
		<div class="col-sm-12 col-xs-12 col-lg-12 col-md-12 adshop-img">
			<img src="{{ URL::asset('assets/images/ad33.png') }}" width="500px">
			<div class="btn_adshop">
				<a href="">VIEW</a>
				<a href="">INQUIRE</a>
				<a href="">ORDER</a>
