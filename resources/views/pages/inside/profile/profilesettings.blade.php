	...
	<div class="row">
		<form method="POST" action="{{ Route('profile.doUpdate') }}" class="form-horizontal" role="form" id="updateform" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="first_name" class="form-control" placeholder="{{ trans('profile.placeholders.prof_details.first_name') }}" value="<?php echo $profile->registration->first_name; ?>">
				</div>
				<div class="col-sm-4">
					<input type="text" name="last_name" class="form-control" placeholder="{{ trans('profile.placeholders.prof_details.last_name') }}" value="<?php echo $profile->registration->last_name?>">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">{{ trans('profile.labels.prof_details.bday') }}</label>
				<div class='col-sm-8'>
					<input type="date" class="form-control" id="birth_date" name="birth_date" required value="<?php echo $profile->registration->birth_date?>" >
				</div>
			</div>
			<div class="form-group">
				...
				<div class="radio col-sm-2">
					<label>
						<input type="radio" name="gender" value="M"  disabled @if($profile->registration->gender == 'M') checked @endif >
						{{ trans('profile.labels.prof_details.gender.male') }}
					</label>
				</div>
				<div class="radio col-sm-2">
					<label>
						<input type="radio" name="gender" value="F" disabled @if($profile->registration->gender == 'F') checked @endif >
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8 nopad">
						<div class="col-lg-12">
							<textarea class="form-control" name="address_line1" placeholder="{{ trans('profile.placeholders.prof_details.addr_l1') }}" rows="3"><?php echo $profile->registration->address_line1; ?></textarea>
						</div>
					</div>
				</div>
				<br clear="all">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-3 nopad">
						<div class="col-lg-12">
							<textarea class="form-control" name="address_line2" placeholder="{{ trans('profile.placeholders.prof_details.addr_l2') }}" rows="3"><?php echo $profile->registration->address_line2; ?></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class='col-sm-8'>
					<input type='text' name="city" class="form-control" value="<?php echo $profile->registration->city ?>"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">{{ trans('profile.labels.prof_details.zip') }}</label>
				<div class='col-sm-8'>
					<input type='text' name="zip" class="form-control" value="<?php echo $profile->registration->zip ?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">{{ trans('profile.labels.prof_details.state') }}</label>
				<div class='col-sm-8'>
					<input type='text' name="state" class="form-control" value="<?php echo $profile->registration->state ?>"/>
				</div>
			</div>
			<div class="form-group">
