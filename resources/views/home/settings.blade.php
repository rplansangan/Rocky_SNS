			...
			<div class="row">
				<form method="POST" action="{{ route('profile.setings.patch') }}" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="last_name" class="form-control" placeholder="Last Name" @if(Session::has('details.last_name')) value="{{ Session::get('details.last_name') }}" @endif >
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="email" class="form-control" name="email_address_confirmation" placeholder="Confirm Email Address" required @if(Session::has('details.email_address')) value="{{ Session::get('details.email_address') }}" @endif >
						</div>
					</div>
					<div class="form-group">
